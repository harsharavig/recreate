        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-8 md:mb-12">
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-medium mb-4 md:mb-6 leading-tight px-4 md:px-0" style={{ color: '#ffffff' }}>
              Join the <span className="serif-italic">newsletter.</span>
            </h1>
          </div>
          ...
          <div className="text-center py-12 px-4 md:px-0">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-400 mb-6">
                Sign up for our newsletter in the footer to get the latest updates on AI automation and lead generation.
              </p>
            </div>
          </div>
        </div>
